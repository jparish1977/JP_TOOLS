...
**The third line is the one that earns its place, and it is also the only one nobody volunteers.** That is not an argument against it. It may be the most valuable of the three BECAUSE nobody writes it unasked, but that is a different claim from "this describes what people already do", and the honest one.

Measured on 2026-09-01, two seats, two tools. Fields one and two were written **before anyone specified a format**: *what it answers*, and *what it was tested against* with real numbers in it (`"took #207 from 23.30% to 2.56%"`, `"found 12 where grep found 10"`). One seat also wrote the third field unprompted -- a containment harness whose docstring records *"unprivileged, scratch dir, no live cupsd"*, by an author who self-tested it end to end **and then broke it on purpose** to confirm it went red: *"a harness that has only ever passed is not evidence."* **The other seat wrote it only after being asked for those three fields by name.**

An earlier draft of this paragraph said both volunteered it, and cited a commit made *in response to that request* as evidence the format was natural. The seat concerned caught it: **a format was asked for, supplied, and then the supply was cited as proof the format needed no asking.** That is circular, and it is the failure this section's own question exists to catch, so it is recorded rather than quietly fixed.
