...
The first three rows came out of JP_TOOLS PR #37, 2026-09-01, across three review
rounds. `spool-audit-containment-fixtures.py` is `camhelp-docs`', `forged-verdict-probe.py`
...
The next four, `run-suites.sh`, `test-against-ref.sh`, `ci-job-fields.py` and
`file-sizes.py`, are `jp-tools`' from the PR #59 work, 2026-09-14 (`ec646bd`).
`doc-pointers.py` is `jp-tools`' check for #53 (`5c3b681`).
